module booth8_chip (clk,
 ...
 sky130_fd_sc_hd__dfrtp_1 _723_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .RESET_B(_030_),
    .Q(\u_core.Q[6] ));
 sky130_fd_sc_hd__dfrtp_1 _724_ (.CLK(clknet_2_2__leaf_clk),
    .D(_084_),
    .RESET_B(_031_),
    .Q(\u_core.Q[7] ));
 sky130_fd_sc_hd__dfrtp_4 _725_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .RESET_B(_032_),
    .Q(\u_core.M[0] ));
 sky130_fd_sc_hd__dfrtp_1 _726_ (.CLK(clknet_2_0__leaf_clk),
    .D(_086_),
    .RESET_B(_033_),
    .Q(\u_core.M[1] ));
 ...
 sky130_fd_sc_hd__dfrtp_2 _739_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .RESET_B(_046_),
    .Q(\u_core.A[6] ));
 sky130_fd_sc_hd__dfrtp_2 _740_ (.CLK(clknet_2_2__leaf_clk),
    .D(_100_),
    .RESET_B(_047_),
    .Q(\u_core.A[7] ));
 sky130_fd_sc_hd__dfrtp_4 _741_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .RESET_B(_048_),
    .Q(\u_core.A[8] ));
 sky130_fd_sc_hd__dfrtp_2 _742_ (.CLK(clknet_2_2__leaf_clk),
    .D(_102_),
    .RESET_B(_049_),
    .Q(\u_core.A[9] ));
 sky130_fd_sc_hd__dfrtp_1 _743_ (.CLK(clknet_2_2__leaf_clk),
    .D(_103_),
    .RESET_B(_050_),
    .Q(\u_core.A[10] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _746_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .RESET_B(_053_),
    .Q(\u_core.A[13] ));
 sky130_fd_sc_hd__dfrtp_1 _747_ (.CLK(clknet_2_3__leaf_clk),
    .D(_107_),
    .RESET_B(_054_),
    .Q(\u_core.A[14] ));
